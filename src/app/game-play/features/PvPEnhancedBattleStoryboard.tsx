...
export default function PvPEnhancedBattleStoryboard() {
  const { gameState, exportBattleLog } = useOnlineGameStore();
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex gap-4 mt-2 text-xs text-gray-400">
                      <span className="flex items-center gap-1">
                        ...
                        Player 1: {entry.player1?.health || 0} HP
                      </span>
                      <span className="flex items-center gap-1">
                        <span className="text-red-400">●</span>
                        Player 2: {entry.player2?.health || 0} HP
                      </span>
                    </div>
                    {isMostRecent && (
